...
class Day4ViewController: UIViewController, IndicatorInfoProvider {
    ...
    override func viewDidLoad() {
        ...
        self.defaults.set("Thursday", forKey: "day")
    ...
    func updateUI() {
        dateLabel.text = "Thursday \(weather.date)"
    ...
    func indicatorInfo(for pagerTabStripController: PagerTabStripViewController) -> IndicatorInfo{
        ...
        return IndicatorInfo(title: " Thursday ")
    }
