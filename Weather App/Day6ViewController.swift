...
class Day6ViewController: UIViewController, IndicatorInfoProvider {
    ...
    override func viewDidLoad() {
        ...
        self.defaults.set("Saturday", forKey: "day")
    ...
    func updateUI() {
        dateLabel.text = "Saturday \(weather.date)"
    ...
    func indicatorInfo(for pagerTabStripController: PagerTabStripViewController) -> IndicatorInfo{
        ...
        return IndicatorInfo(title: " Saturday ")
    }
