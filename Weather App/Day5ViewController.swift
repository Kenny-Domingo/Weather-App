...
class Day5ViewController: UIViewController, IndicatorInfoProvider {
    ...
    override func viewDidLoad() {
        ...
        self.defaults.set("Friday", forKey: "day")
    ...
    func updateUI() {
        dateLabel.text = "Friday \(weather.date)"
    ...
    func indicatorInfo(for pagerTabStripController: PagerTabStripViewController) -> IndicatorInfo{
        ...
        return IndicatorInfo(title: " Friday ")
    }
